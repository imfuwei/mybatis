...
public class MyTest {
	...
	//第三方EHcache二级缓存的用法：
	//1.导入jar包，第三方jar的核心包ehcache-core-2.6.8.jar，mybatis与ehcache连接的jar包mybatis-ehcache-1.0.3.jar
	//2.将ehcache-core-2.6.8.jar中ehcache配置文件ehcache-failsafe.xml拿出来，重命名为ehcache.xml放到src下
	//3.在映射文件中，配上<cache type="org.mybatis.caches.ehcache.EhcacheCache"/>
	//4.实体类不用串行化，ehcache已经帮我们做了
